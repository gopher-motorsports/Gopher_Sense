...
GENERAL_PARAMETER bucket_1_bucket_general_param_list[20] =
{
  {
...
ANALOG_SENSOR_PARAM adc1_sensor_params[NUM_ADC1_PARAMS] = 
{
  ...
  // adc1_param9
  {
    .bucket_param = bucket_1_bucket_general_param_list + 8,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc1_param10
  {
    .bucket_param = bucket_1_bucket_general_param_list + 9,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
...
ANALOG_SENSOR_PARAM adc3_sensor_params[NUM_ADC3_PARAMS] = 
{
  ...
  // adc3_param1
  {
    .bucket_param = bucket_1_bucket_general_param_list + 10,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param2
  {
    .bucket_param = bucket_1_bucket_general_param_list + 11,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param3
  {
    .bucket_param = bucket_1_bucket_general_param_list + 12,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param4
  {
    .bucket_param = bucket_1_bucket_general_param_list + 13,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param5
  {
    .bucket_param = bucket_1_bucket_general_param_list + 14,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param6
  {
    .bucket_param = bucket_1_bucket_general_param_list + 15,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param7
  {
    .bucket_param = bucket_1_bucket_general_param_list + 16,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param8
  {
    .bucket_param = bucket_1_bucket_general_param_list + 17,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param9
  {
    .bucket_param = bucket_1_bucket_general_param_list + 18,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
  ...
  // adc3_param10
  {
    .bucket_param = bucket_1_bucket_general_param_list + 19,
    .analog_sensor = &current_sensor_for_pdm,
    .num_filtered_subparams = 0, // not yet implemented
    .filtered_subparams = NULL, // not yet implemented
    .buffer =
